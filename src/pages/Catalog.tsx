...
const services = [
  {
    ...
    description: 'Diseño web profesional que refleja la identidad de tu marca.',
    category: 'web',
    price: 'Desde $1,500 MXN',
    features: ['Diseño responsivo', 'Panel de administración', 'Integración con redes sociales'],
