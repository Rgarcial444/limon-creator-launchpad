...
const FeaturedServices = () => {
  ...
  const benefits = [{
    icon: CheckCircle2,
    text: "Diseño que inspira confianza"
  }, {
    icon: CheckCircle2,
  ...
  return <section className="container mx-auto px-6 py-16">
      ...
      <div className="mb-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          return <article key={index} className="group p-6 rounded-xl bg-card border border-border hover:border-primary/50 transition-all hover:shadow-lg">
                <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {service.tags.map((tag, tagIndex) => <span key={tagIndex} className="px-2 py-1 text-xs rounded-md bg-primary/5 text-primary">
                      {tag}
                    </span>)}
                </div>
              </article>;
